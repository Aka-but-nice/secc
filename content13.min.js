/* Copyright 2026 Securly, Inc. All rights reserved. */ ! function() {
    globalThis.debuglog = {
        enabled: !1,
        log: function(t) {
            if (this.enabled) try {
                console.log(`${performance.timeOrigin+performance.now()} ${t}`)
            } catch (t) {
                console.error(t)
            }
        },
