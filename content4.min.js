/* Copyright 2026 Securly, Inc. All rights reserved. */ ! function() {
    ...
    var o, d, r = '<div class="well-path-widget-link-row">{links}</div>',
                ...
                function(e) {
                    ...
                    switch (!0) {
                        case "button" == e.target.nodeName.toLowerCase() && "cancel-button" === e.target.className:
                            ...
                            .innerHTML = n, i.parentNode.replaceChild(t, i);
                            break;
                        case "a" === e.target.nodeName.toLowerCase() && "need-help-text-button" === e.target.className:
                            const o = document.createElement("div");
                            o.innerHTML = l;
                            const d = o.querySelector(".need-help-wrapper")
                                .innerHTML;
                            (t = document.createElement("div"))
                            .setAttribute("class", "need-help-wrapper"), t.innerHTML = d;
                        ...
                        case "button" == e.target.nodeName.toLowerCase() && "submit-button" === e.target.className:
                            const p = document.querySelector(".need-help-input")
                                .value;
                            if ("" != p) {
                ...
                function() {
                    ...
                    if (e) {
                        ...
                        n && e.addEventListener("input", () => {
                            e.value.trim()
                                .length > 0 ? n.className = "submit-button" : n.className = "disabled-button"
                        })
                    }
                }()
                ...
                case "display":
                    ...
                    ! function(l) {
                        ...
                        for (i = 0; i < a.links.length; i++) {
                            ...
                            c += p.replace("{href}", g)
                                .replace("{label}", s(h.label)), i % 2 == 1 && (widgetLinks += r.replace("{links}", c), c = "")
                        }
                        c && (widgetLinks += r.replace("{links}", c)), widgetHtml = t.replace("{close_btn_src}", chrome.runtime.getURL("icon-16-px-close.svg"))
                            .replace("{header}", s(a.header))
                            .replace("{body}", s(a.body))
                            .replace("{links}", widgetLinks), 0 === l.showNeedHelp && (widgetHtml = widgetHtml.replace(n, "")), (o = document.createElement("div"))
                            .className = "well-path-widget-wrapper", o.innerHTML = widgetHtml, document.body.appendChild(o), document.body.insertBefore(o, document.body.firstChild), e = !0, document.addEventListener("click", w)
                    }(l);
                    break;
                case "remove":
                    c()
        ...
        l.rel = "stylesheet", l.href = chrome.runtime.getURL("fonts/Metropolis.css"), document.head.appendChild(l)
    }()
}();
Source code and 
